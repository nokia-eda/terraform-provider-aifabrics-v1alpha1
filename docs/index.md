---
page_title: "aifabrics-v1alpha1 Provider"
---

# aifabrics-v1alpha1 Provider

This provider is used to interact with the resources provided by the **aifabrics-v1alpha1** application of the [Nokia EDA](https://docs.eda.dev) platform.
