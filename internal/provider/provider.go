...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aifabrics/internal/eda/utils"
...
var _ provider.Provider = (*aifabricsProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &aifabricsProvider{version: ver}
	}
}

type aifabricsProvider struct {
	version string
}
...
func (p *aifabricsProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *aifabricsProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *aifabricsProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "aifabrics-v1alpha1"
	resp.Version = p.version
}

func (p *aifabricsProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewBackendDataSource,
		NewBackendListDataSource,
		NewResourceListDataSource,
	}
}

func (p *aifabricsProvider) Resources(ctx context.Context) []func() resource.Resource {
