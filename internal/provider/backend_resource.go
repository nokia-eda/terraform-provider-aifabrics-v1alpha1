...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-aifabrics/internal/resource_backend"
	"github.com/nokia/eda/apps/terraform-provider-aifabrics/internal/tfutils"
)

const (
	create_rs_backend = "/apps/aifabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/backends"
	read_rs_backend   = "/apps/aifabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/backends/{name}"
	update_rs_backend = "/apps/aifabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/backends/{name}"
	delete_rs_backend = "/apps/aifabrics.eda.nokia.com/v1alpha1/namespaces/{namespace}/backends/{name}"
)

var (
	_ resource.Resource                = (*backendResource)(nil)
	_ resource.ResourceWithConfigure   = (*backendResource)(nil)
	_ resource.ResourceWithImportState = (*backendResource)(nil)
)
...
func (r *backendResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_backend, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_backend, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_backend,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *backendResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_backend, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *backendResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_backend, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
